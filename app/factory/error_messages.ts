...
export const zeroTokens_message: string = 'You have 0 credits. You cannot make the request';
...
export const videoAlreadyExitsArray_message: string = 'Check the videos inserted. There can be no duplicates.'
